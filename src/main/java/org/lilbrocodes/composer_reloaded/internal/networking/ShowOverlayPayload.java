...
import org.lilbrocodes.composer_reloaded.internal.networking.handler.ShowOverlayHandler;


import static org.lilbrocodes.composer_reloaded.api.v1.registry.ComposerRegistries.OVERLAY_SERIALIZERS;
import static org.lilbrocodes.composer_reloaded.api.v1.registry.ComposerRegistryKeys.OVERLAY_SERIALIZERS_KEY;
...
public record ShowOverlayPayload<T extends Overlay>(T overlay)
    ...
    public static final Identifier oID = ComposerReloaded.identify("show_overlay_s2c");

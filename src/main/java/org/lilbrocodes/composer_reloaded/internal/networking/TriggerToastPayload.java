...
import org.lilbrocodes.composer_reloaded.internal.networking.handler.TriggerToastHandler;

import static org.lilbrocodes.composer_reloaded.api.v1.registry.ComposerRegistries.TOAST_SERIALIZERS;
import static org.lilbrocodes.composer_reloaded.api.v1.registry.ComposerRegistryKeys.TOAST_SERIALIZERS_KEY;
...
public record TriggerToastPayload<T extends AbstractToast>(T toast, ToastManager.Corner corner)
    ...
    public static final Identifier oID = ComposerReloaded.identify("trigger_toast_s2c");

package org.lilbrocodes.composer_reloaded.api.v1.item.settings.component;
...
public class SoulboundComponent {
    public static boolean isSoulbound(ItemStack stack) {
        ...
        return settings != null && settings.composerReloaded$soulbound();
        *///? }
    }
    ...
    public static boolean canDropSoulbound(ItemStack stack) {
        ...
        //?} else {
        /*ItemMethodAccessor settings = ItemMethodAccessor.get(stack);
        return settings != null ? settings.composerReloaded$soulboundCanDrop() : true;
        *///? }
    }

...
import com.codex.composer.api.v1.registry.lazy.DeferredCompositeEventRegistry;
import com.codex.composer.api.v1.util.builder.BuilderFields;
import com.codex.composer.internal.Composer;

import java.util.Locale;

public class ComposerCompositeEvents {
    private static final DeferredCompositeEventRegistry REGISTRY = new DeferredCompositeEventRegistry(Composer.MOD_ID);
